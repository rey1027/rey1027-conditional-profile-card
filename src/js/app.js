    ...
    variables.country == null ? " " : variables.country
          ...
          <ul class="${variables.socialMediaPosition}">
            <li><a href="https://twitter.com/${
              variables.twitter == null ? "reypereira10" : variables.twitter
            }"><i class="fab fa-twitter"></i></a></li>
            <li><a href="https://github.com/${
              variables.github == null ? "rey1027" : variables.github
            }"><i class="fab fa-github"></i></a></li>
            <li><a href="https://www.linkedin.com/in/${
              variables.linkedin == null
                ? "rachel-pereira-0ba994254"
                : variables.linkedin
            }/"><i class="fab fa-linkedin"></i></a></li>
            <li><a href="https://instagram.com/${
              variables.instagram == null ? "rey_pereirag" : variables.instagram
